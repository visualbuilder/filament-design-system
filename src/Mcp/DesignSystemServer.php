...
#[Instructions(<<<'EOT'
    ...
    2. Reason about the change requested. Translate visual asks ("make the
       ...
       For colour edits, prefer to update the full shade ramp (50→950) rather
       than a single shade so the design stays coherent.
    3. Call write_tokens with a partial { tokens, panel } tree. By default
